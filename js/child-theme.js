...
(function (global, factory) {
	...
	*/
	...
	jQuery(document).ready(function ($) {
	  ...
	  jQuery(".team-section .member-details h3").click(function () {
	    jQuery(this).parents('.team-member-wrap').addClass('show-details');
	  });
	  ...
	  jQuery(document).click(function () {
	    jQuery(".team-member-wrap").removeClass('show-details');
	  });
	  ...
	  jQuery(".dropdown-single-wrap ul li").on("mousedown", function () {
	    jQuery(this).parents(".dropdown-single-wrap").find(".dropdown-toggle").text($(this).text());
	  });
	  ...
	  if (jQuery(window).width() > 767) {
	    jQuery(window).on('load resize', function () {
	      ...
	      jQuery('.blog-details h4').css({
	        'min-height': blogdetails
	      });
	    });
	  }
	  ...
	  if (jQuery(window).width() > 767) {
	    jQuery(window).on('load resize', function () {
	      var memberpost = 0; //for the description section
	      //Calculating the description new height

	      jQuery('.card-content-wrap h6').each(function () {
	        if (memberpost < jQuery(this).outerHeight()) {
	          memberpost = jQuery(this).outerHeight();
	        }
	      }); //Calculating the description new height

	      jQuery('.card-content-wrap h6').css({
	        'min-height': memberpost
	      });
	    });
	  } // Counter START
