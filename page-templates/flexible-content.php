...
if( have_rows('page_flexible_content') ): 
	while( have_rows('page_flexible_content') ): the_row();
		...
		elseif( get_row_layout() == 'hero_slider' ):
			get_template_part('page-templates/template-parts/hero-slider');
		elseif( get_row_layout() == 'testimonial' ):
			get_template_part('page-templates/template-parts/testimonial-list');
		...
		elseif( get_row_layout() == 'three-column-images' ):
			get_template_part('page-templates/template-parts/three-column-images');
		elseif( get_row_layout() == 'testimonial-slider' ):
			get_template_part('page-templates/template-parts/testimonial-slider');
		elseif( get_row_layout() == 'our_team' ):
			get_template_part('page-templates/template-parts/team');
		elseif( get_row_layout() == 'contact_info' ):
			get_template_part('page-templates/template-parts/contact');
		elseif( get_row_layout() == 'dropdown_section' ):
			get_template_part('page-templates/template-parts/dropdown-section');
