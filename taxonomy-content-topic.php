    ...
    <div class="container mb-5">
        <div class="filter-wrap">
            ...
            <ul>
                ...
                <li data-cat="10">Exiting &amp; Selling</li>
                <li data-cat="38">Finance</li>
                <li data-cat="18">Increasing Profit</li>
                <li data-cat="36">Management</li>
                <li data-cat="37">News</li>
                <li data-cat="37">People</li>
                <li data-cat="37">Planning</li>
                <li data-cat="21">Sales &amp; Marketing</li>
                <li data-cat="37">Starting Up </li>
                <li data-cat="37">Tax</li>
            </ul>
        </div>
    </div>
        ...
        <div class="infobox-warp">
                        ...
                        <div class="col-md-6 col-xl-4 <?= $counter; ?>" <?= $counter > $ppp ? 'style="display:none;"' : ''; ?> data-pagenumber="resources<?= ceil($counter / $ppp); ?>">
                            <div class="info-box">
                                <a href="<?php the_permalink(); ?>" class="text-decoration-none blog-img">     
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/3943716.jpg" class="img-fluid" alt="">
                                </a>
            ...
            if ($posts_loop->found_posts > $ppp) { ?>
                <div class="text-center my-5 py-3">
                    <a href="javascript:void(0);" class="btn blue-btn resources-load-more navyblue-btn" data-pagenumber="1">Load More</a>
                </div>
            <?php } ?>
